      ...
      <div className="space-y-4 text-black">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <input
              ...
              className="w-full text-sm p-2 border border-grray-400 rounded-md focus:ring-2 focus:ring-indigo-500 outline-none"
            />
          </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <div className="flex -items-center gap-2 boder border-gray-400 rounded-md p-1">
              <input
                type="text"
                value={
